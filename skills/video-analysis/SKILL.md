---
name: video-analysis
description: Analyze local video or audio files with ffmpeg/ffprobe, Parakeet MLX or Whisper transcription, contact sheets, checkpoint frames, and timestamped issue notes. Use ONLY when the user explicitly invokes this skill by name. Never trigger it automatically.
